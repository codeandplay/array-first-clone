/**
 * array-first <http://github.com/jonschlinker/array-first>
 *
...
describe('first', function () {
  it('should throw en error if the value passed is not an array:', function () {
    (function () {
      first()
  ...
  it('should the first n element of the array: ', function () {
